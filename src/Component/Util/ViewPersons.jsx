                    ...
                    <div className="header-top-menu tabl-d-n">
                      <ul className="nav navbar-nav mai-top-nav">
                        ...
                        <li className="nav-item dropdown res-dis-nn">
                          <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" className="nav-link dropdown-toggle">Project <span className="angle-down-topmenu"><i className="fa fa-angle-down" /></span></a>
                        ...
                        <li className="nav-item"><a href="#" className="nav-link">Support</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                      ...
                      <ul className="nav navbar-nav mai-top-nav header-right-menu">
                        ...
                        <li className="nav-item">
                          ...
                          <ul role="menu" className="dropdown-header-top author-log dropdown-menu animated zoomIn">
                            <li><a href="#"><span className="edu-icon edu-home-admin author-log-ic" />My Account</a>
                            </li>
                            <li><a href="#"><span className="edu-icon edu-user-rounded author-log-ic" />My Profile</a>
                            </li>
                            <li><a href="#"><span className="edu-icon edu-money author-log-ic" />User Billing</a>
                            </li>
                            ...
                            <div className="tab-content custom-bdr-nt">
                              <div id="Notes" className="tab-pane fade in active">
                                <div className="notes-area-wrap">
                                  <div className="note-heading-indicate">
                                    <h2><i className="fa fa-comments-o" /> Latest Notes</h2>
                              ...
                              <div id="Projects" className="tab-pane fade">
                                <div className="projects-settings-wrap">
                                  <div className="note-heading-indicate">
                                    <h2><i className="fa fa-cube" /> Latest projects</h2>
              ...
              <div className="mobile-menu">
                <nav id="dropdown">
                  <ul className="mobile-menu-nav">
                    ...
                    <li><a data-toggle="collapse" data-target="#demomi" href="#">Mailbox <span className="admin-project-icon edu-icon edu-down-arrow" /></a>
    ...
    <div className="contacts-area mg-b-15">
      <div className="container-fluid">
        <div className="row">
          <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <div className="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30">
              <div className="panel-body custom-panel-jw">
                ...
                <img alt="logo" className="img-circle m-b" src="img/contact/1.jpg" />
                <h3><a href>John Alva</a></h3>
                <p className="all-pro-ad">London, LA</p>
                <p>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <div className="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30">
              <div className="panel-body custom-panel-jw">
                ...
                <img alt="logo" className="img-circle m-b" src="img/contact/2.jpg" />
                <h3><a href>Amir dex</a></h3>
                <p className="all-pro-ad">Pakistan, Los</p>
                <p>
                  Lorem ipsum dolor sit amet of, consectetur adipiscing elitable. Vestibulum tincidunt est vitae ultrices accumsan.
                </p>
              </div>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <div className="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30 res-tablet-mg-t-30 dk-res-t-pro-30">
              <div className="panel-body custom-panel-jw">
                <div className="social-media-in">
                  <a href="#"><i className="fa fa-facebook" /></a>
                  <a href="#"><i className="fa fa-twitter" /></a>
                ...
                <img alt="logo" className="img-circle m-b" src="img/contact/3.jpg" />
                <h3><a href>Alva Adition</a></h3>
                <p className="all-pro-ad">India, Col</p>
                <p>
                  Lorem ipsum dolor sit amet of, consectetur adipiscing elitable. Vestibulum tincidunt est vitae ultrices accumsan.
                </p>
              </div>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <div className="hpanel hblue contact-panel contact-panel-cs res-tablet-mg-t-30 dk-res-t-pro-30">
              <div className="panel-body custom-panel-jw">
                <div className="social-media-in">
                  <a href="#"><i className="fa fa-facebook" /></a>
                  <a href="#"><i className="fa fa-twitter" /></a>
                ...
                <img alt="logo" className="img-circle m-b" src="img/contact/4.jpg" />
                <h3><a href>Sex Dog</a></h3>
                <p className="all-pro-ad">Uk, LA</p>
                <p>
                  Lorem ipsum dolor sit amet of, consectetur adipiscing elitable. Vestibulum tincidunt est vitae ultrices accumsan.
                </p>
              </div>
        ...
        <div className="row">
          <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <div className="hpanel hblue contact-panel contact-panel-cs mg-t-30">
              <div className="panel-body custom-panel-jw">
                <div className="social-media-in">
                  <a href="#"><i className="fa fa-facebook" /></a>
                  <a href="#"><i className="fa fa-twitter" /></a>
                ...
                <p className="all-pro-ad">California, LA</p>
                <p>
                  Lorem ipsum dolor sit amet of, consectetur adipiscing elitable. Vestibulum tincidunt est vitae ultrices accumsan.
                </p>
              </div>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <div className="hpanel hblue contact-panel contact-panel-cs mg-t-30">
              <div className="panel-body custom-panel-jw">
                ...
                <p className="all-pro-ad">Austrolia, LA</p>
                <p>
                  Lorem ipsum dolor sit amet of, consectetur adipiscing elitable. Vestibulum tincidunt est vitae ultrices accumsan.
                </p>
              </div>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <div className="hpanel hblue contact-panel contact-panel-cs mg-t-30">
              <div className="panel-body custom-panel-jw">
                ...
                <p className="all-pro-ad">Suiden, Cro</p>
                <p>
                  Lorem ipsum dolor sit amet of, consectetur adipiscing elitable. Vestibulum tincidunt est vitae ultrices accumsan.
                </p>
              </div>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <div className="hpanel hblue contact-panel contact-panel-cs mg-t-30">
              <div className="panel-body custom-panel-jw">
                ...
                <p className="all-pro-ad">USA, LA</p>
                <p>
                  Lorem ipsum dolor sit amet of, consectetur adipiscing elitable. Vestibulum tincidunt est vitae ultrices accumsan.
                </p>
              </div>
